...
- レポートID: `WBS_COMPLETION_EVIDENCE_T849_1` / 実施日: 2026-08-30
- 判定: **ok** (10/10 仮説PASS)
- WBS完了率: **96.0%**（完了412 / 実行中9 / 未着手8 / 総数429）
- 期限超過(未完了): T791, T807, T813, T819, T823, T831, T834, T845, T849, T911, T944, T957, T977
...
| --- | --- | --- | --- | --- |
| PUBLIC-04 | HUMAN_GATE | T1003 | — | lane |
| PUBLIC-08 | WARNING | T1002 | — | human_or_mixed |
| PUBLIC-09 | BLOCKED | T791, T807, T813 | — | human_or_mixed |
| PUBLIC-11 | BLOCKED | T944, T999 | R151 | human_or_mixed |
| PUBLIC-13 | BLOCKED | T845, T849, T850 | R151 | human_or_mixed |
| PUBLIC-15 | WARNING | T849, T999 | R151 | human_or_mixed |

## 10仮説検証

| # | 仮説 | 結果 | 根拠 |
| --- | --- | --- | --- |
| H1 | WBSが解析でき、ステータス内訳の合計が総数に一致する | PASS | 完了412+実行中9+未着手8=429 |
| H2 | 完了率が算出され、9割超である | PASS | 完了率=96.0%（412/429） |
| H3 | 期限超過の未完了タスクを検出できる（可視化対象） | PASS | 期限超過(未完了)=['T791', 'T807', 'T813', 'T819', 'T823', 'T831', 'T834', 'T845', 'T849', 'T911', 'T944', 'T957', 'T977'] |
...
| H8 | 各非PASSゲートが残タスク/HUMAN_GATE/未解決課題/再評価候補として説明できる | PASS | 説明不能な非PASSゲート=なし / 再評価候補(関連全完了かつ未解決課題なし)=なし / 未解決課題でPASS再判定不可=なし |
| H9 | 残作業が人間依存/レーン/再評価候補に分類できる | PASS | 残作業の分類=['human_or_mixed', 'lane'] |
| H10 | 集約出力が内部整合している（完了数の再計算一致） | PASS | 完了数再計算=412(=412) |
