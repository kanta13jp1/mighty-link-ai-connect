...
| public_paid_launch | NO_GO | 12 | BLOCKED:6, HUMAN_GATE:2, PASS:4 |
...
| PUBLIC-01 | public_paid_launch | セキュリティ | PASS | 四半期セキュリティ監査・外部疑似診断と監査検出事項修正が完了している | docs/SECURITY_AUDIT_REPORT_2026-Q2.md; docs/EXTERNAL_PENTEST_RUNBOOK.md; exports/external_pentest_review.md; exports/firebase_hosting_headers_review.md; firebase.json; requirements.txt | T789;T802;T805;T835 | 開発責任者 | Bandit High/Medium 0、pip-audit 0、T805 High 0 / secret-like値露出 0を確認済み。T835でFirebase Hosting本番URLのCSP / X-Content-Type-Options等ヘッダhardeningを完了。GitHub Pagesはcontrolled demo mirrorとして制約をdocsへ記録。public_paid_launch全体は他のBLOCKED/HUMAN_GATE項目で別途No-Go判定。 |
