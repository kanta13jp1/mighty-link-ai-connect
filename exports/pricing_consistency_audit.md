...
- 料金参照docs: **8件** (ACCOUNTING_AND_TAX_OPERATIONS_RUNBOOK.md, MIKIWAME_AI_INTEGRATION_POC_DESIGN.md, PAID_LAUNCH_GO_NO_GO_DECISION_PACK_2026-07-24.md, PRICING_PLAN_SPECIFICATION.md, PRODUCT_ENHANCEMENT_ACTION_PLAN.md, PROJECT_GLOSSARY.md, SALES_PROPOSAL_EFFECTIVENESS_SUMMARY.md, STRIPE_TAX_AND_INVOICE_COMPLIANCE_RUNBOOK.md)
- 総合判定: ✅ PASS (ドリフト0)
...
| H9 | 料金参照docsを自動検出でき対象が空でない | ✅ | 対象docs=['ACCOUNTING_AND_TAX_OPERATIONS_RUNBOOK.md', 'MIKIWAME_AI_INTEGRATION_POC_DESIGN.md', 'PAID_LAUNCH_GO_NO_GO_DECISION_PACK_2026-07-24.md', 'PRICING_PLAN_SPECIFICATION.md', 'PRODUCT_ENHANCEMENT_ACTION_PLAN.md', 'PROJECT_GLOSSARY.md', 'SALES_PROPOSAL_EFFECTIVENESS_SUMMARY.md', 'STRIPE_TAX_AND_INVOICE_COMPLIANCE_RUNBOOK.md'] |
