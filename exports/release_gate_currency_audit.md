...
- 陳腐化ゲート(非PASSだが関連WBS全完了): **3件** ['PUBLIC-04', 'PUBLIC-08', 'PUBLIC-11']
- 総合判定: ✅ PASS (ドリフト0)
...
| 仮説 | 内容 | 判定 | 詳細 |
| :-- | :-- | :-- | :-- |
| H1 | ゲート台帳が読み込め非空 | ✅ | ゲート=21 / WBS=427 |
| H2 | ゲートIDが一意 | ✅ | 重複=なし |
...
| H6 | 陳腐化ゲート(非PASSだが関連WBS全完了)が再評価待ちとして注記済み | ✅ | 陳腐化=['PUBLIC-04', 'PUBLIC-08', 'PUBLIC-11'] / 未注記=なし |
