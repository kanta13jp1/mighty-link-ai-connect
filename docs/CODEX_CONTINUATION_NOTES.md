...
## 2026-05-22 Codex continuation: T667 Seedance風デモUI刷新

ユーザー要望「SeedanceのHPに似たデザインに改善」に対応し、社長共有済み公開URLの第一印象を黒基調AI studio UIへ刷新した。

### 完了内容

- `index.html` / `src/index.html`: ファーストビューを黒基調、強いタイポグラフィ、映像AIプロダクト風プレビュー、4軸メトリクス表示へ変更。
...
- `data/qa_tracker.tsv`: Q-AHOC-20260522-3 (Seedance風デザインの扱い) を回答済みとして登録。
