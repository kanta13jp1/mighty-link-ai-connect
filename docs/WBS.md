...
| **T845** | 8. 本番運用・品質管理 | 品質管理 | 全機能本番受入E2E/UAT最終再検証（社内診断・勤怠・営業メールAI・課金・同意・管理者） | Codex + Antigravity | VSCode + Codex + Antigravity + Playwright | T745/T752/T770/T791/T807/T817_7/T842完了後に、主要ユーザー導線、管理者導線、Firebase本番URL、GitHub Pages controlled demo、Supabase保存/RLS、Stripe test/live、同意UI、削除/エクスポートを横断検証し、証跡をexportsとSheetsへ同期する。Issue #132 / Project #1 Todo | 未着手 |
| **T846** | 8. 本番運用・品質管理 | ドキュメント | ユーザー操作ガイド・管理者Runbook・FAQの全機能最終更新 | Claude Code + Codex | VSCode + Claude Code + Codex | docs/USER_GUIDE_AND_FAQ.mdを、営業メールAIマッチング、従業員アンケート、勤怠CSV解析、管理者ダッシュボード、Stripe課金、データ削除/エクスポート、サポートSLAの最新実装へ更新し、古いPDF/Basic認証/サンプル前提を削除する。Issue #133 / Project #1 Todo | 未着手 |
...
| **T848** | 8. 本番運用・品質管理 | 外部連携 | AIモデル・外部SaaS・連携サービス棚卸しとGA時点利用可否の最終凍結 | Codex + Claude Code | VSCode + Codex + Claude Code + official docs | Anthropic/OpenAI/Google/Microsoft/Meta/Amazon/Apple/xAI/Kimi/MiMo/DeepSeek/BytePlus/GitHub/Slack/Notion/Obsidian/Unity/Figma/Canva/Reddit/InsForge/FireCrawl/Discord/Stripe/Supabase/お名前.comの利用有無、契約、モデル名、API version、fallback、廃止予定、secret管理、会社請求移管状態を棚卸しし、GA時点の採用/非採用を凍結する。Issue #135 / Project #1 Todo | 未着手 |
| **T849** | 9. 長期保守・拡張 | 共通管理 | サイト開発完了総合判定・WBS全完了証跡化・GAリリース閉鎖 | Codex + Claude Code + 人間 | VSCode + Codex + Claude Code + GitHub + Google Workspace | 全WBSが完了、全公開前Go/No-GoがPASSまたは承認済み、GitHub Issues/Project未完了0、data/issues_tracker.tsvの開発必須open 0、data/qa_tracker.tsvの未回答/未承認QA 0、Sheets/Calendar同期済み、main/master/GA tag/GitHub Release/Firebase本番/NotebookLM/Driveが一致していることを確認し、このタスク完了をもってサイト開発完了と宣言する。Issue #136 / Project #1 Todo | 未着手 |
| **T850** | 8. 本番運用・品質管理 | 運用引継ぎ | 会社運用引継ぎリハーサル・権限棚卸し・Break-glass確認 | 寛太梅澤 + Codex + Claude Code | 人間 + VSCode + Codex + Google Workspace | T823の会社アカウント移管後、GitHub/Firebase/GCP/Supabase/Stripe/Google Workspace/AI開発ツールの管理者、請求、退職時権限削除、緊急時Break-glass、運用Runbookに沿った復旧/問い合わせ対応を会社側でリハーサルし、属人化を解消する。Issue #137 / Project #1 Todo | 未着手 |
