...
| **T854** | 8. 本番運用・品質管理 | 品質管理 | 課題管理表・QA表の未解決/未回答棚卸しと開発ブロッカーゼロ化 | Codex + Claude Code + 人間 | VSCode + Codex + Claude Code + Google Workspace + GitHub | data/issues_tracker.tsv、data/qa_tracker.tsv、Google Sheetsの課題管理表/QA表、GitHub Issues/Projectを突合し、open課題と未回答/未承認QAを「解決済み」「非ブロッカーとして承認済み」「T849後の保守タスクへ移管」のいずれかに分類する。開発完了前に開発必須open課題0、未回答/未承認QA 0を証跡化する。T846/T847/T848前倒し完了により、最終棚卸しをT850前へ移動。Issue #141 / R101 / PUBLIC-15 | 未着手 |
