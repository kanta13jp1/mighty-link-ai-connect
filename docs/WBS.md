...
| **T848** | 8. 本番運用・品質管理 | 外部連携 | AIモデル・外部SaaS・連携サービス棚卸しとGA時点利用可否の最終凍結 | Codex + Claude Code | VSCode + Codex + Claude Code + official docs | docs/AI_SAAS_SERVICE_FREEZE_RUNBOOK.mdを追加し、Anthropic/OpenAI/Google/Microsoft/Meta/Amazon/Apple/xAI/Kimi/MiMo/DeepSeek/BytePlus/GitHub/Slack/Notion/Obsidian/Unity/Figma/Canva/Reddit/InsForge/FireCrawl/Discord/Stripe/Supabase/Firebase/お名前.comの採用/非採用、モデル/API、fallback、secret管理、会社請求移管を凍結。Gemini現行実装はgemini-2.5-flash+deterministic fallback、最新安定版移行はT769/T780で検証、DeepSeek旧名廃止予定も明記。Issue #135 / Project #1 Done | 完了 |
