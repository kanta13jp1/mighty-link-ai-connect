...
- 対応WBS: T818（移行準備ランブック完了）, T823（本移管実施）
- 移行準備の正本は [ACCOUNT_OWNERSHIP_MIGRATION_RUNBOOK.md](../ACCOUNT_OWNERSHIP_MIGRATION_RUNBOOK.md) とし、認証情報やsecretの実値は記録しない。
...
| T817_6 | Codex / Claude Code | 人間レビュー、評価ログ、フィードバック改善ループを整備する | 完了 |
| T817_7 | Codex / Claude Code | 本番運用、個人情報、監査、負荷確認を完了する | 未着手 |
| T818 | 寛太梅澤 | 個人アカウントから会社アカウント、会社請求への移行準備を進める | 完了 |
| T823 | 寛太梅澤 + Codex | 会社GitHub Organization、Firebase/GCP、Supabase、AI開発ツール、請求先の本移管を実施する | 未着手 |
