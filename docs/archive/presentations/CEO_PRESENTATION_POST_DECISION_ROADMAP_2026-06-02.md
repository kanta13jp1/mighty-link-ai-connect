...
> 現在の扱い（2026-06-27 T854）:
> 本書は2026-06-02社長打ち合わせ前に作成した歴史的テンプレです。
> 現行の開発正本は `data/WBS.tsv`、`docs/WBS.md`、2026-06-17議事録、`docs/PRODUCTION_GO_NO_GO_CHECKLIST.md` です。
> 本書のA/B/C/D案を現在の実装方針として扱わないでください。
