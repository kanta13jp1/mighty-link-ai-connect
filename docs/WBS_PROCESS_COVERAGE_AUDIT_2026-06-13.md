...
| 2. 設計 | T102/T730_1〜3 DB・アーキ・セキュリティ設計、T788 ステージング、T776 Stripe 設計 | **GAP-1: ロールバック手順書なし → T812** |
...
| 5. リリース | T501/T734 CI/CD、T746 Go/No-Go、T806 バージョニング、T793 ローンチアナウンス | GAP-1 と共通（ロールバック） |
...
| T812 | 本番リリースのロールバック手順書整備 | Codex + Claude | 6/19〜6/20 | Hosting/Functions のロールバックと Supabase スキーマ巻き戻し手順が未文書化。T746 Go/No-Go チェックリストの前提资料 |
