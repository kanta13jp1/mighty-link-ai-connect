...
| 役割・機能 | 採用モデル | 特徴・選択理由 |
| :--- | :--- | :--- |
| **メインチャット＆エージェント駆動・長文推論** | **Gemini 3.5 Flash** | 爆速、超低コスト、長コンテキスト。**I/O 2026 公表ベンチで Gemini 3.1 Pro を 4 倍速で上回る** ため、長文推論も Flash で出荷可能 ([Best Practices Refresh](MULTI_AI_WORKFLOW.md#best-practices-refresh-2026-05-22) 参照)。 |
| **マルチモーダル入出力処理** | **Gemini Omni** | テキスト・画像・音声・動画を1つの世界モデルでシームレスに理解。Antigravity 2.0 の live voice transcription にも接続。 |
| **将来導入候補** | **Gemini 3.5 Pro** | 一般公開タイミングは Google 公式アナウンス待ち。公開後に Flash と並走して品質比較する想定。本プロジェクトの 6/2 出荷は Flash で完結する方針 (R1 リスク降格済)。 |
