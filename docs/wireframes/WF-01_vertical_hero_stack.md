...
| output target | `exports/wireframes/wf-01.html` (single file) |
...
Stack constraints:
- Single HTML file at exports/wireframes/wf-01.html
...
Output: complete exports/wireframes/wf-01.html with embedded <style> and <script>. Verify locally with:
  python src/app.py
  open http://localhost:8000/exports/wireframes/wf-01.html
```
